...
```mermaid
graph TD
    A[Apostadores/Usuarios] -->|Apuestan $GCH| B(Pool Parimutuel)
    B -->|90%| C[Ganadores del Match]
    B -->|5%| D[Burn/Deflación 🔥]
    B -->|3%| E[Jackpot Comunitario 🏆]
    B -->|2%| F[Tesorería/Dev 🛠️]
    G[NFT Holders] -->|Staking/Yield| A
