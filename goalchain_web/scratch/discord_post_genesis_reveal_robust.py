...
class RobustGenesisReveal(discord.Client):
            ...
            for guild in self.guilds:
                ...
                if dev_channel:
                    ...
                    if os.path.exists(image_path):
                        ...
                        print("Genesis Reveal publicado con éxito.")
                        await asyncio.sleep(2) # Esperar para asegurar el envío
        except Exception as e:
            print(f"Error durante el envío: {e}")
        finally:
            await self.close()

bot = RobustGenesisReveal(intents=discord.Intents.all())
bot.run(TOKEN)
