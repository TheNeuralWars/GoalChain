...
|--------|----------|--------|
| **Hermes** (Manager) | Chat Discord (#hermes), issues, priorización | `xai/grok-4.6` (conversación, triage y coordinación) |
...
# Manager (conversación y triage)
OA_MODEL=xai/grok-4.6
