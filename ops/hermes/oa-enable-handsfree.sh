...
ensure_key "OA_AGENT_CURSOR_CMD" "bash ${HERMES_HOME}/scripts/oa-agent-runner.sh cursor"
ensure_key "OA_AGENT_ANTIGRAVITY_CMD" "bash ${HERMES_HOME}/scripts/oa-agent-runner.sh antigravity"
