...
copy_script "fcc-resolve-tier.sh"
copy_script "configure-fcc-env.sh"
copy_script "install-fcc-skills.sh"
...
copy_script "mcp-goalchain-ops.py"
copy_script "goalchain-alpha-watch.sh"
copy_script "goalchain-morning-conclusions.sh"
