    ...
    for idx, batch_players in enumerate(batches):
        ...
        for p in batch_players:
            ...
            prompt_str = (
                ...
                f"KIT UPDATE: Replace the plain kit from '{padded_id}.jpg' with: {jersey_desc} containing the player's jersey number {jersey_number} printed in a clean modern font in the center of the chest, a 3D GoalChain logo on the left chest (use the uploaded 'logo_3d_jersey.jpg' as the exact visual design reference for the GoalChain logo, rendering it as a premium 3D miniature version), and a 3D Solana logo (three parallel slash bars in neon teal-to-purple gradient) on the right chest. Absolutely NO other branding, sponsor logos, or flags. "
