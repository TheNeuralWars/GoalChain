...
export function ClassicHub() {
    ...
    return (<div className="play-page play-page--portal portal-fade-in">
      <div className="portal-header glass-card" style={{ textAlign: 'center', padding: '2rem' }}>
        <div className="portal-badge" style={{ background: 'rgba(20,241,149,0.15)', color: '#14f195', marginBottom: '1rem' }}>
          🔄 HUB EN MIGRACIÓN
        </div>
      ...
      <div className="launcher-grid" style={{ marginTop: '1.5rem' }}>
        {modules.map((m) => (<Link key={m.to} to={m.to} className="launcher-card glass-card" style={{ textDecoration: 'none', display: 'block', cursor: 'pointer' }}>
