...
export function DashboardGrid() {
    ...
    return (<div className="inicio-portal">
      <EconomyConfigBanner />
      {/* Welcome Hero Banner */}
      <div className="welcome-hero glass-card portal-fade-in">
        <div className="welcome-hero-content">
          ...
          {!user && (<Link to="/club" className="btn-neon-green welcome-hero-btn">
      ...
      <div className="ops-collapsible-wrapper glass-card">
        <button onClick={() => setShowOpsConsole(prev => !prev)} className="ops-toggle-btn" aria-expanded={showOpsConsole}>
        ...
        {showOpsConsole && (<div className="ops-collapsible-content portal-fade-in">
            <OpsStatusPanel />
          </div>)}
      </div>
