...
export function GameModal({ gameId, onClose }) {
    ...
    return (<div className="gc-modal-overlay" role="dialog" aria-modal="true" aria-label={title} onClick={(e) => {
      ...
      <div className="gc-modal gc-modal--game glass-strong">
        <header className="gc-modal-head">
          ...
          <button type="button" className="gc-modal-close" aria-label={language === 'es' ? 'Cerrar' : 'Close'} onClick={onClose}>
            ✕
          </button>
        </header>
