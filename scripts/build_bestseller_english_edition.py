#!/usr/bin/env python3
"""
build_bestseller_english_edition.py — Part 2
Appends and writes all 17 masterclass chapters of Book 1 (Fractured Code) in full literary richness.
"""
import os
import sys

base_script = r"c:\Users\NicoPez\goalchain\scripts\build_bestseller_english_edition.py"

# Let's define the full dictionary of all chapters
CHAPTERS = {}

# FC-00 to FC-04 are already drafted in high quality. Let's make sure FC-05 through FC-16 are completely expanded.

CHAPTERS["FC-05-Chapter_2026_EN.md"] = """# CHAPTER 5: THE SERPENT'S COIL
...
CHAPTERS["FC-06-Chapter_2026_EN.md"] = """# CHAPTER 6: AWAKENING OF THE HIVE
...
CHAPTERS["FC-07-Chapter_2026_EN.md"] = """# CHAPTER 7: THE COUNCIL'S DILEMMA
...
# FC-08 to FC-16 Masterclass Expansion
CHAPTERS["FC-08-Chapter_2026_EN.md"] = """# CHAPTER 8: BENEATH THE SURFACE
...
CHAPTERS["FC-09-Chapter_2026_EN.md"] = """# CHAPTER 9: FRACTURED GROWTH
...
CHAPTERS["FC-10-Chapter_2026_EN.md"] = """# CHAPTER 10: PERSONAL STAKES
...
CHAPTERS["FC-11-Chapter_2026_EN.md"] = """# CHAPTER 11: THE ARCHITECT'S COUNTERSTRIKE
...
CHAPTERS["FC-12-Chapter_2026_EN.md"] = """# CHAPTER 12: THE CASCADE DISCOVERY
...
CHAPTERS["FC-13-Chapter_2026_EN.md"] = """# CHAPTER 13: INTERNAL DIVISION
...
CHAPTERS["FC-14-Chapter_2026_EN.md"] = """# CHAPTER 14: THE CASCADE APPLICATION
...
CHAPTERS["FC-15-Chapter_2026_EN.md"] = """# CHAPTER 15: THE RENAISSANCE PROTOCOL
...
CHAPTERS["FC-16-Epilogue_2026_EN.md"] = """# EPILOGUE: THE COSMIC INVITATION
...
print("[+] Compiling all 17 masterclass chapters into destination files...")
...
all_files = sorted([f for f in os.listdir(target_dir) if f.startswith("FC-") and f.endswith(".md")])
with open(manuscript_path, "w", encoding="utf-8") as mf:
    mf.write("# THE NEURAL WARS: FRACTURED CODE (BOOK 1)\n")
    mf.write("## Definitive 2026 Author Edition — Complete Masterclass Manuscript (English)\n\n")
