...
file_path = r'c:\Users\lucas\.gemini\antigravity\scratch\GoalChain\docs\app.html'

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Regular expression to find the AI AGENT HUB section
# We look for "<!-- SECTION: AI AGENT HUB -->", then everything until the next "<!-- SECTION: " or the end of the file.
# Wait, it ends with "</section>\n\n        <!-- SECTION: MINIGAMES HUB (NEW) -->"
pattern = re.compile(r'(\s*<!-- SECTION: AI AGENT HUB -->.*?)(?=\s*<!-- SECTION: MINIGAMES HUB \(NEW\) -->)', re.DOTALL)
                            ...
                            <div style="display:flex; flex-direction:column; gap:15px;">
                                <div style="background: rgba(0,0,0,0.2); padding: 15px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.03);">
                                    ...
                                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px;">
                                        ...
                                        <a href="https://flash.trade?ref=goalchain" target="_blank" class="btn btn-primary" style="width: 100%; font-size:0.7rem; display:flex; align-items:center; justify-content:center; text-decoration:none; color:#000; font-weight:bold; background:var(--primary);">
                                            OPERAR EN MAINNET 🚀
                                        </a>
                                    </div>
                                </div>
