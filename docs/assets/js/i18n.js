...
const TRANSLATIONS = {
    es: {
        ...
        pitch_feat2_t: "Economía Real", pitch_feat2_d: "Modelo de <b>Infinity Burn</b> diseñado para la sostenibilidad perpetua. <br><br><b>Flujo Circular:</b> El 10% de cada apuesta se distribuye automáticamente: 40% al Jackpot y 30% a la World Reserve para recomprar y quemar tokens usando el yield.",
    ...
    en: {
        ...
        pitch_feat2_t: "Real Economy", pitch_feat2_d: "<b>Infinity Burn</b> model designed for perpetual sustainability. <br><br><b>Circular Flow:</b> 10% of each bet is automatically distributed: 40% to Jackpot and 30% to the World Reserve to buy back and burn tokens using yield.",
