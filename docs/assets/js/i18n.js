...
const TRANSLATIONS = {
    es: {
        ...
        pitch_feat2_t: "Economía Real", pitch_feat2_d: "Modelo on-chain verificable. <br><br> El fee de apuestas está gobernado por parámetros del protocolo (hard-cap actual: <b>1%</b>) y tesorería comunitaria.",
        ...
        econ_flow_desc: "Apostadores → Pools Parimutuel (Solana) → 99% Ganadores / 1% Fee (hard-cap) <br> Builder Fund (10%) financia contributors + APIs/modelos + marketing.",
        ...
        econ_feat2_t: "Fee y Quema Gobernables", econ_feat2_d: "Los fees y sinks se ajustan por gobernanza. Hoy el fee on-chain está capado en 1% para minimizar extracción y mejorar fairness.",
    ...
    en: {
        ...
        pitch_feat2_t: "Real Economy", pitch_feat2_d: "Verifiable on-chain model. <br><br> Betting fees are protocol-governed (current hard-cap: <b>1%</b>) with community treasury routing.",
        ...
        econ_flow_desc: "Bettors → Parimutuel Pools (Solana) → 99% Winners / 1% Fee (hard-cap) <br> Builder Fund (10%) finances contributors + APIs/models + marketing.",
        ...
        econ_feat2_t: "Governed Fees & Burn", econ_feat2_d: "Fees and sinks are governance-adjusted. Current on-chain fee hard-cap is 1% to reduce extraction and improve fairness.",
