...
const TRANSLATIONS = {
    es: {
        ...
        pitch_feat2_t: "Economía Real", pitch_feat2_d: "Modelo deflacionario real diseñado para la sostenibilidad a largo plazo. <br><br><b>Flujo Circular:</b> El 10% de cada apuesta se retira para alimentar el Jackpot Comunitario y el tesoro, creando una presión de compra constante y recompensando a los holders activos.",
        pitch_feat3_t: "Cromos 3D", pitch_feat3_d: "100 leyendas únicas de la Genesis Squad listas para el juego. <br><br><b>Activos Productivos:</b> Cada NFT genera Yield diario y dividendos basados en el rendimiento real. Evoluciona a tus jugadores y mejora sus estadísticas mediante la participación activa.",
        pitch_feat4_t: "Minijuegos PvP", pitch_feat4_d: "Acción inmediata sin esperas. Reta a la comunidad global en cualquier momento. <br><br><b>Competición:</b> Domina el Minijuego de Penaltis o forma tu equipo 5v5 para torneos exclusivos con premios en SOL y tokens $GCH para los mejores del ranking.",
        pitch_feat5_t: "100% On-Chain", pitch_feat5_d: "Seguridad institucional. Toda la lógica reside en el smart contract (Rust/Anchor). <br><br><b>Verificabilidad:</b> Sin servidores ocultos. Los oráculos de datos deportivos alimentan los resultados de forma automática, asegurando un entorno de juego justo y auditable.",
        ...
        econ_flow_desc: "Apostadores → Pool Parimutuel (Solana) → 90% Ganadores / 10% Protocolo <br> Protocolo → 5% Burn 🔥 / 3% Jackpot 🏆 / 2% Tesorería 🛠️",
    ...
    en: {
        ...
        pitch_feat2_t: "Real Economy", pitch_feat2_d: "Real deflationary model designed for long-term sustainability. <br><br><b>Circular Flow:</b> 10% of each bet is withdrawn to fuel the Community Jackpot and treasury, creating constant buy pressure and rewarding active holders.",
        pitch_feat3_t: "3D Cards", pitch_feat3_d: "100 unique Genesis Squad legends ready for action. <br><br><b>Productive Assets:</b> Each NFT generates daily Yield and dividends based on real-world performance. Evolve your players and boost their stats through active participation.",
        pitch_feat4_t: "PvP Minigames", pitch_feat4_d: "Immediate action with no waiting. Challenge the global community at any time. <br><br><b>Competition:</b> Master the Penalty Minigame or build your 5v5 team for exclusive tournaments with SOL and $GCH prizes for the top rankers.",
        pitch_feat5_t: "100% On-Chain", pitch_feat5_d: "Institutional security. All logic resides in the smart contract (Rust/Anchor). <br><br><b>Verifiability:</b> No hidden servers. Sports data oracles feed results automatically, ensuring a fair and auditable gaming environment.",
        ...
        econ_flow_desc: "Bettors → Parimutuel Pool (Solana) → 90% Winners / 10% Protocol <br> Protocol → 5% Burn 🔥 / 3% Jackpot 🏆 / 2% Treasury 🛠️",
        ...
        econ_feat4_t: "The Perfect Balance", econ_feat4_d: "Inflation attracts new capital. Gameplay incentivizes constant spending. The result is a circular economy where token value is sustained by real utility.",
