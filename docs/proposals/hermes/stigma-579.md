# OA Proposal: Issue #579 — [OPENCODE] [P0][webapp][ops] Deploy play.goalchain.fun with VITE_API_BASE_URL production
...
## Issue Body
## Objective
[P0][webapp][ops] Deploy play.goalchain.fun with VITE_API_BASE_URL production
