# OA Proposal — Issue #460

## Title
[P2][growth][daily-routine] Mobile PWA + Responsive Landing with Presale CTA
...
- Rollback: revert branch `exp/opencode-issue-460` and close draft PR.
