# OA Proposal: Issue #604 — [OPENCODE] [P1][ci][devnet] GitHub Action run smoke-devnet.sh on webapp PRs
...
## Issue Body
## Objective
[P1][ci][devnet] GitHub Action run smoke-devnet.sh on webapp PRs
