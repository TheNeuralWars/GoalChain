# OA Proposal: Issue #585 — [OPENCODE] [P1][webapp][api] Integrate /api/coach/chat in Play via apiBaseUrl
...
## Issue Body
## Objective
[P1][webapp][api] Integrate /api/coach/chat in Play via apiBaseUrl
