# OA Proposal — Issue #484

## Title
[OPENCODE] [IMPL] #364 TradingTerminal → features/trading (6 comps + 4 hooks)
...
- Rollback: revert branch `exp/opencode-issue-484` and close draft PR.
