# OA Proposal — Issue #476

## Title
[opencode] P1: Build comprehensive Jito/MEV observability dashboard and alerting: bundle success rates, tip efficiency, MEV capture metrics, ShredStream latency, and economy health correlation — all feeding into existing `/api/economy/health` and Hermes cron alerts.
