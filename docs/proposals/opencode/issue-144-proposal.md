...
Full specification: `docs/intake/GITHUB_ISSUES_BACKLOG_MUNDIAL_2026.md` (issue #36).
...
- Rollback: revert branch `exp/opencode-issue-144` and close draft PR.
