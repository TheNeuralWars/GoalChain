...
Full specification: `docs/intake/GITHUB_ISSUES_BACKLOG_MUNDIAL_2026.md` (issue #44).
...
- Rollback: revert branch `exp/opencode-issue-152` and close draft PR.
