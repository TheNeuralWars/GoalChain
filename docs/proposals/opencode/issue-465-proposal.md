...
## Objective
## Objective
Create three foundational governance documents for GoalChain open source collaboration.
...
- Rollback: revert branch `exp/opencode-issue-465` and close draft PR.
