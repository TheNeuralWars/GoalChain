...
Full specification: `docs/intake/GITHUB_ISSUES_BACKLOG_MUNDIAL_2026.md` (issue #39).
...
- Rollback: revert branch `exp/opencode-issue-147` and close draft PR.
