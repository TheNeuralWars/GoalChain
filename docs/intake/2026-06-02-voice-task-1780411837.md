# Voice Task: controla todos los repost de @goalchainsol y @goalchaindotfun

- **Task Created:** https://github.com/TheNeuralWars/GoalChain/issues/289
- **Task Status:** ready
...
> controla todos los repost de @goalchainsol y @goalchaindotfun en X. extrae las cosas que nos podrian ser utiles, y utilizalas, aplicalas, utilizalas en nuestro trabajo
