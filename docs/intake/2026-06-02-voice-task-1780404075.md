# Voice Task: how is the status of the queue of

- **Task Created:** https://github.com/TheNeuralWars/GoalChain/issues/281
- **Task Status:** ready
...
> how is the status of the queue of the tasks?
