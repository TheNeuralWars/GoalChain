# Voice Task: programa e inicia a usar esto ; https://crm.goalchain.fun/settings/profile

- **Task Created:** https://github.com/TheNeuralWars/GoalChain/issues/277
- **Task Status:** ready
...
; https://crm.goalchain.fun/settings/profile
