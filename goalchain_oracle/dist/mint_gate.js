...
const DEFAULT_CSV = path.resolve(process.cwd(), "../docs/data/tokenomics_scenarios.csv");
...
function computeDecision(rows, days) {
    ...
    if (ratio > 1.2) {
        ...
        return {
            ...
            burn_7d_gch: burn,
            ratio_burn_over_emit: ratio,
            reason: "Ratio above 1.20. Mint is allowed with conservative buffer and treasury review.",
        };
    }
    return {
        allow: true,
