...
import { PlayerError, deriveFixturePda, deriveParodyPlayerPda, derivePlayerMatchRecordPda, } from "./types.js";
export async function recordPlayerMatch(oracle, input) {
    ...
    try {
        ...
        throw PlayerError.fromError("PLAYER_RECORD_FAILED", error, { matchId, playerId });
    }
}
