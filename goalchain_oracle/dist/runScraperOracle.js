...
async function main() {
    ...
    try {
        ...
        const [fixturePda] = PublicKey.findProgramAddressSync([Buffer.from("fixture"), Buffer.from(matchState.matchId)], oracle.program.programId);
        ...
        if (!fixtureAccountInfo) {
            ...
            await oracle.initializeFixture(matchState.matchId, matchState.teamA, matchState.teamB, startTime);
        }
        else {
        ...
        await oracle.upsertLiveState(matchState.matchId, matchState.minute, matchState.scoreA, matchState.scoreB, matchState.isHt, matchState.isFt);
