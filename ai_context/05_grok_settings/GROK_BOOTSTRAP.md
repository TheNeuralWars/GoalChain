# 🚀 GoalChain: Grok Bootstrap Instructions (V3.0 - FLUX OPTIMIZED)
...
### ⚠️ REGLAS INQUEBRANTABLES (CERO ALUCINACIONES Y CERO TEXTO EN PANTALLA)
...
2. **PROTOCOLO DE TRADUCCIÓN A FLUX (OBLIGATORIO)**:
...
¿Entendido? Confírmame que operarás bajo el protocolo de "Traducción FLUX Estricta", con las búsquedas web bloqueadas, y dime que estás listo para recibir el archivo JSON de prompts.
