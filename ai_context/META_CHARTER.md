...
> **Source:** [entropyvortex/meta-llm-charter](https://github.com/entropyvortex/meta-llm-charter) (vendored in GoalChain).  
> **Local policy:** Zero-Pause is **opt-in** only — see `.cursor/rules/meta-principal.mdc`. Default agents use R1–R11 without autonomous pause loops.
